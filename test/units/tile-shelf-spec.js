describe("TileShelf", function() {
  ...
  describe("addTile()", function() {
    ...
    it("Throws an error if there is no room for the tile", function() {
      expect(()=> {
        TileShelf.addTile(Tile({ code:'forest-1' }));
        TileShelf.addTile(Tile({ code:'forest-2' }));
    ...
    it("Adds tile to the front of the array", function() {
      ...
      TileShelf.addTile(Tile({ code:'forest-1' }));
      TileShelf.addTile(Tile({ code:'forest-2' }));
      TileShelf.addTile(Tile({ code:'forest-3' }));
  ...
  describe("removeTile()", function() {
    it("Removes a tile given it's position.", function() {
      TileShelf.setSize(3);
      TileShelf.addTile(Tile({ code:'forest-1', id:101 }));
      TileShelf.addTile(Tile({ code:'forest-2', id:102 }));
      TileShelf.addTile(Tile({ code:'forest-3', id:103 }));
