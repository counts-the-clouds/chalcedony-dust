...
// The finger dragging scrolling gestures on a Mac look completely different from the windows mouse wheel events,
// though they are both bound to the same wheel event. The Mac scrolling is more frequent with smaller deltas. In
// order to make the zoom work pretty much the same way between the two I include more granular zoom levels when we
// know we're on a mac.
global.SCALE_FACTORS = {
  MAC:[2,1.980,1.825,1.713,1.676,1.641,1.570,1.535,1.501,1.467,1.434,1.401,1.368,1.336,1.305,1.273,1.243,1.212,1.183,
       1.154,1.125,1.096,1.068,1.041,1.000,0.987,0.961,0.935,0.910,0.882,0.860,0.836,0.813,0.767,0.745,0.723,0.702,
       0.681,0.660,0.640,0.621,0.602,0.583,0.565,0.547,0.530,0.513,0.496,0.480,0.465,0.450,0.435,0.421,0.407,0.393,
       0.381,0.368,0.356,0.344,0.333,0.323,0.312,0.303,0.293,0.285,0.276,0.268,0.261,0.253,0.247,0.241,0.235,0.229,
       0.225,0.220,0.216,0.213,0.209,0.207,0.205,0.203,0.201,0.200],
  WIN:[2,1.570,1.368,1.183,1.000,0.860,0.702,0.583,0.480,0.393,0.323,0.268,0.220,0.200]
}

// The value of 1 in the associated SCALE_FACTORS array.
global.DEFAULT_SCALE = { MAC:24, WIN:4 }
